...
// Clearing allows identical consecutive messages to re-trigger a readout.
...
export const AnnouncerProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <AnnouncerContext.Provider value={{ announce }}>
      {children}
      <Box component="div" role="status" aria-live="polite" aria-atomic="true" sx={srOnlySx}>
        {politeMessage}
      </Box>
      <Box component="div" role="alert" aria-live="assertive" aria-atomic="true" sx={srOnlySx}>
        {assertiveMessage}
      </Box>
