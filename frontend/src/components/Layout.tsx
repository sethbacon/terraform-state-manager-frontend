...
export default function Layout() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar />
        {/* Cap content width (left-aligned) at lg to match the registry baseline so
            pages line up across the suite. API docs is exempt (its two-column swagger
            layout uses the full width, as in the registry). */}
